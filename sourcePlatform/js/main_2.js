...
//         pageNo = 1;
//     }
//     //var kkpagerStr = JSON.stringify(kkpager) ;
//     //生成分页
//     //有些参数是可选的，比如lang，若不传有默认值
//     //var kkpager1 = JSON.parse( kkpagerStr ) ;
...
function getSidebarContent(courseId){
    ...
    emptyChild($("#kkpager")) ;
    //$("#kkpager").remove() ;
    // var kkpagerEle = document.getElementById("kkpager") ;
    // while(kkpagerEle.hasChildNodes()){
    //     kkpagerEle.removeChild(kkpagerEle.firstChild);
    // }
    //
    // kkpagerEle.parentNode.removeChild( kkpagerEle ) ;
    //
    // var kkDiv = document.createElement("div") ;
    // kkDiv.setAttribute("id" , "kkpager") ;
    // kkDiv.setAttribute("class" , "pageSelectCon") ;

    //document.getElementById("mainContent").appendChild(kkDiv) ;
